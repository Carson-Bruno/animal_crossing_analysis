...
seasonality TEXT,
mannequin_season TEXT,
gender TEXT,
villager_gender TEXT,
style_1 TEXT,
style_2 TEXT,
label_themes TEXT,
sort_order INT,
villager_equippable TEXT,
catalog TEXT,
version_added TEXT,
unlocked TEXT,
filename TEXT,
...
DROP TABLE IF EXISTS clothing_other;
CREATE TABLE clothing_other(
name TEXT,
closet TEXT,
storage	TEXT,
variation TEXT,
